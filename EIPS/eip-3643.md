...
- Identity Storage/Registry: A storage system for all ONCHAINIDs and their associated claims, which is used to verify the eligibility of investors during transfers.
